...
export default class Luckyturntable extends React.Component{
    constructor(props) {
      super(props);
        ...
        <View>
          <View className="canvas-container">
            <View animation={this.state.animationData} className="canvas-content" >
              ...
              <View /*onClick={this.onGetLottery}*/ onClick={this.onGetLottery.bind(this)} className="canvas-btn ">{this.props.buttonTitle||'小激励'}</View>
          </View>
